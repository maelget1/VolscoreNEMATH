...
<table class="table table-bordered border-dark">
  <tr class="text-center"><th><a href="?action=team&id=<?=$game->receivingTeamId?>" class="link"><?=$actualGame->receivingTeamName?></a> <img src="<?=$sexSymbol?>" alt="sexe de la team"></th><th><?=$actualGame->scoreReceiving?></th><th><?=$actualGame->league?> <?=$actualGame->type?></th><th><?=$actualGame->scoreVisiting?></th><th><a href="?action=team&id=<?=$game->visitingTeamId?>" class="link"><?=$actualGame->visitingTeamName?></a> <img src="<?=$sexSymbol?>" alt="sexe de la team"></th></tr>
